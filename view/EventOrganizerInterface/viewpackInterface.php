...
require_once '../../controller/EventOrganizerController/viewcontroller.php';

$data = new viewcontroller();
$result = $data->index();
...
<body>
    ...
    <select name="sort">
      ...
      <option value="PkgName">BY NAME</option>
      <option value="PkgPrice">BY PRICE</option>
