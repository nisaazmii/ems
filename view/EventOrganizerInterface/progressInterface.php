...
<head>
    ...
    <!-- Title -->
    <title>Update Progress List</title>
    ...
    <!-- container -->
     <div class="container">
        ...
        <div class="page-header">
            <h1>Update Progress List</h1>
        </div>
		 <a href='progdetailsInterface.php' class='btn btn-primary m-b-1em'>List Testing Attendance</a>
                    ...
                    <tr>
					  ...
					  <td>
                        <form method="POST" action="">
                          ...
                          <input type="submit" name="btnDetail" class="btn btn-danger" formaction="./formattendInterface.php" value="DETAIL">
                        </form>
