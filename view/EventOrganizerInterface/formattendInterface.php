<?php
require_once '../../controller/EventOrganizerController/progressController.php';
...
<body>
    ...
    <div class="container">
		...
		<h3 class="form-signin-heading" align="center">POST ATTEND</h3>
		
            <table class='table table-hover table-responsive table-bordered'>
			<center>
                <tr>
                    <td>Type of Testing</td>
                    <td><b><input type="radio" name="testing" value="FOOD TESTING" >FOOD TESTING<br>
					<input type="radio" name="testing" value="PA SYSTEM SOUND CHECK" >PA SYSTEM SOUND CHECK<br></td>
                </tr>
				...
				<tr>
                    <td>Venue</td>
                    <td><b><input type="radio" name="venue" value="CHEF KITCHEN KK3"> CHEF KITCHEN KK3<br>
						<input type="radio" name="venue" value="CHEF KITCHEN K01" checked> CHEF KITCHEN K01<br></td>
                </tr>
