                ...
                <tbody>
                  ...
                  <tr>
                    <tr>
                      ...
                      <td>
                         <a href="../../view/PaymentInterface/bill.php?id=<?php echo $res['bookingid']; ?>" class="btn btn-primary pull-left" style="margin-right: 5px">Pay</a>

                         <a href="Cart.php?id=<?php echo $res['bookingid']; ?>" class="btn btn-primary pull-left" style="margin-right: 5px">Equipment</a>
