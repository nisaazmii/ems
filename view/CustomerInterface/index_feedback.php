<?php
require_once '../../controller/CustomerController/feedback_controller.php';

if (isset($_POST['submit'])) 
{
	
	// create controller
	$index_feedback = new feedback_controller();
...
<body>
    ...
    <form class="form-signin" action="" method="POST">
        ...
        <h3>Please leave your thought and give feedback to rate and improve our services.</h3>
        <br>
        
        <h4> Overall, how did you feel about the service you receive?</h4>
        <input type="radio" name="rate" value="Very Satisfied" checked>Very Satisfied</input>
        <br><input type="radio" name="rate" value="Satisfied">Satisfied</input>
        <br><input type="radio" name="rate" value="Neither Satisfied or Dissatisfied">Neither Satisfied or Dissatisfied</input>
        <br><input type="radio" name="rate" value="Dissatisfied">Dissatisfied</input>
        <br><input type="radio" name="rate" value="Very Dissatisfied">Very Dissatisfied</input>
        <br>
        <br>
            
        <h4>How to we improve our services?</h4>
        <textarea name = "comments" rows = "5" cols = "80" class="form-control"></textarea>
        
        <td>(Limit is 1200 characters)</td>

        <br><br>
        <td>Please don't include any personal or financial information,
            for example your National Insurance or credit card numbers.</td>
        ...
        <td>
            <input class="btn btn-primary" type="submit" name="submit" value="SUBMIT FEEDBACK" 
                onclick="return  confirm('Are you sure to submit the feedback?')">
            <input class="btn btn-danger" type="reset" value="Cancel" onclick="return  confirm('Are you sure to cancel?')"></td>
        </td>
