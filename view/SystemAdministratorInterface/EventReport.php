...
//create object of ReportController class
    ...
    //call event_view function
	$Report->event_view();
    //get the returned value  from event_view
    $mo=$Report->event_view();
...
<body>
    ...
    <!-- Header Area End -->
     ...
     <main id="main">
      ...
      <div id="print">
      <br><br>
       <center><h1> Event Monthly Report</h1>
...
{ 
 ...
 <td> <?php echo $bookingid[$i] ?></td>
 <td> <?php echo $eventname[$i] ?></td>
 <td> <?php echo $packagename[$i] ?></td>
 ...
 <td> <?php
   if (substr($startdate[$i], 5,2)==1)
   {
       echo "January";
 } 
 else if (substr($startdate[$i], 5,2)==2)
 {
        echo "February";
 }
  else if (substr($startdate[$i], 5,2)==3)
 {
        echo "March";
 }
  else if (substr($startdate[$i], 5,2)==4)
 {
        echo "April";
 }
  else if (substr($startdate[$i], 5,2)==5)
 {
        echo "May";
 }
  else if (substr($startdate[$i], 5,2)==6)
 {
        echo "June";
 }
  else if (substr($startdate[$i], 5,2)==7)
 {
        echo "July";
 }
  else if (substr($startdate[$i], 5,2)==8)
 {
        echo "August";
 }
 else if (substr($startdate[$i], 5,2)==9)
 {
        echo "September";
 }
 else if (substr($startdate[$i], 5,2)==10)
 {
        echo "October";
 }
 else if (substr($startdate[$i], 5,2)==11)
 {
        echo "November";
 }
 else
