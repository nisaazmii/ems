...
require_once '../../controller/SupplierController/feedbackController.php';
...
<body>
    ...
    <div class="classy-menu">
        ...
        <div class="classynav">
            <ul id="nav">
                ...
                <li class="active"><a href="feedbackInterface.php">Feedback</a></li>
    ...
    <div class="col-12 col-md-9 col-lg-6">
        ...
        <a href="indexEqInterface.php" class="btn btn-success" role="button">Back</a>
        </table>
        </div>               
        </div>
        </div>
