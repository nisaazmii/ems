...
<body>
    ...
    <div class="col-15 col-md-11 col-lg-8">
        <h2>List of Package</h2><br>

        <div class='right-button-margin'>
            <a href='addPkgInterface.php' class='btn btn-primary m-b-1em'>Add New Package</a>
        </div><br>
        ...
        <div class="card-body table-responsive p-0">
            ...
            <?php foreach ($result as $res) { ?>
                <tr>
                    <tr>
                        <td><?php echo $res['pkgid']; ?></td>
                        <td><?php echo $res['PkgName']; ?></td>
                        <td><?php echo $res['PkgDesc']; ?></td>
                        <td><?php echo $res['PkgPrice']; ?></td>
                        <td><?php echo $res['PkgDate']; ?></td>
                        <td>
                        <a href="updatePkgInterface.php?pkgid=<?php echo $res['pkgid']; ?>" class="btn btn-primary pull-left" style="margin-right: 5px">Update</a><br><br>
                        <input type="hidden" name="delete" value="<?php echo $res['pkgid'] ?>">
