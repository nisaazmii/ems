...
require_once '../../model/EventOrganizerData/bookingInfo.php';
	...
	public function destroy($bookingid){
		...
		$message="The record has been successfully deleted";
                    echo "<script type='text/javascript'> 
                            alert('$message');
                            window.location.href=('../../view/EventOrganizerInterface/indexBookingInterface.php');
                        </script>";
	}
   ...
   public function booking()
    {
       ...
       $message="Your booking is successfully";
                    echo "<SCRIPT type='text/javascript'> 
                     ...
                     header("location: http://localhost/ems/view/PaymentInterface/Bill.php? id=  $us");
